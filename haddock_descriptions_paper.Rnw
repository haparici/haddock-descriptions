...
This high-scope construal of the uniqueness component of the definite article is not entirely synonymous with \ol{rabbit in a big bag}, 
as the latter could felicitously describe a rabbit that is in multiple big bags, assuming that were physically possible, and the former could not. 
But as we do not have those types of situations to contend with, the inner definite effectively disappears.
...
A high interpretation of the comparative necessitates a high interpretation of the definite article. On such an interpretation, \ol{the rabbit in the bigger hat} is true of $r$ if and only if:
%
\begin{enumerate}
  \item $r$ is a rabbit in $C$:\\
    $\valueof{\ol{rabbit}}^{\theta,C}(b) =\true$
...
[linguex not working for some reason]
...
\b. Bernie has the most enthusiastic campaign chairman.
\c. Bernie has the more enthusiastic campaign chairman.
...
\ex.
\a. Who has read the longest play by Shakespeare?
\b. Who has read Shakespeare's longest play?\\
$\equiv$ Who has read Hamlet?


\ex.
\a. Who has read the longer play by Shakespeare?
...
\ex.
\a. the first book that John said Tolstoy had written\label{tolstoy:first}
%\b. the only book that John said Tolstoy had written
\b. the longest book that John said Tolstoy had written\label{tolstoy:longest}
\b. the longer book that John said Tolstoy had written\label{tolstoy:longer}
...
\ex.
\a. John gave Mary the most expensive telescope
\b. ... to be built in the
9th century.


\ex.
\a. John gave Mary the more expensive telescope
\b. ... to be built in the
9th century.
