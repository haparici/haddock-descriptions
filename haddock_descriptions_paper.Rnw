...
allowUninformativeThresholdLevels <- c("lastresort")
...
test_result #cmp:0 pos:0 cond:1
...
df.bumfordCmp<-subset(results, Adjective=="bigger" & DefArtMeaning=="bumford" & Model=="haddock_model.wppl" & ListenerLevel==1 & allowUninformativeThresholds=="lastresort")
